<div class="fixed top-0 dark:bg-[#161616] bg-[#d9e0e1] w-full flex flex-row z-50 max-w-7xl">
   ...
   <div class="right-0 mr-4 my-auto hidden md:flex">
    ...
    <div class="navbar-menu relative z-50 hidden">
		...
		<nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 dark:bg-[#202124] bg-[#d0d5d6] dark:text-white text-black border-r dark:border-r-[#4e5158] overflow-y-auto">
            ...
            <ul class="pt-6 mt-6 rounded-2xl ml-3 mr-3 pb-6 text-left">
                <li class="hover:border-l-[#c5023d] hover:cursor-pointer border-l-2 border-l-transparent hover:bg-gradient-to-r hover:from-gsv-purple/80 hover:to-transparent w-full h-full pt-2 pb-2 mb-2 transition-all duration-300 ease-in">
                ...
                <li class="hover:border-l-[#c5023d] hover:cursor-pointer border-l-2 border-l-transparent hover:bg-gradient-to-r hover:from-gsv-purple/80 hover:to-transparent w-full h-full pt-2 pb-2 mb-2 transition-all duration-300 ease-in">
                    <a class="flex flex-row justify-center" href="/jaarbundel">
                        <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="hover:border-l-[#c5023d] hover:cursor-pointer border-l-2 border-l-transparent hover:bg-gradient-to-r hover:from-gsv-purple/80 hover:to-transparent w-full h-full pt-2 pb-2 mb-2 transition-all duration-300 ease-in">
                    <a class="flex flex-row justify-center" href="/commissies">
                        <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="mt-auto mx-auto flex flex-col">
                <button type="button"
                        x-on:click="darkMode = !darkMode"
                        x-bind:class="darkMode ? 'bg-gsv-purple-dark' : 'bg-gsv-purple'"
                        class="relative ring-2 hover:ring-white ring-transparent border-transparent inline-flex h-8 w-8 flex-shrink-0 cursor-pointer rounded-full border-2 transition-colors duration-200 ease-in-out focus:outline-none focus:gsv-purple-dark mx-auto pt-6"
                        role="switch" aria-checked="false">
                    <span class="sr-only">Dark mode toggle</span>
                    <span
                        x-bind:class="darkMode ? 'opacity-0 ease-out duration-100' : 'opacity-100 ease-in duration-200'"
                    ...
                    <span x-bind:class="darkMode ? 'opacity-100' : 'opacity-0'"
                        class="pointer-events-none absolute inset-0 flex h-full w-full items-center justify-center transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 m-auto text-white" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd"
                                d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z"
                                clip-rule="evenodd" />
                        </svg>
