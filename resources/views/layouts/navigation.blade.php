<div class="md:flex hidden fixed top-0 dark:bg-[#161616] bg-[#d9e0e1] min-h-screen max-h-screen w-52 flex-col pt-6 z-50">
    ...
    <x-navigation.user-show />
    
    <nav>
        <ul class="dark:text-white text-black pt-6 mt-6 dark:bg-[#202124] bg-[#d0d5d6] rounded-2xl ml-3 mr-3 pb-6 text-center">
            <x-navigation.menu-item title="Forum" link="/"> 
            ...
            <x-navigation.menu-item title="Jaarbundel" link="/jaarbundel"> 
                <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <x-navigation.menu-item title="Foto's" link="https://www.dropbox.com/sh/35nn6690kcvk7wx/AACnG0OpTvw4I1WcvwUhOZYaa?dl=0"> 
                <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <x-navigation.menu-item title="Commissies" link="/commissies"> 
                <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <x-navigation.menu-item title="Admin" link="/admin"> 
                <svg fill="none" class="h-6 w-6 mr-2" viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
