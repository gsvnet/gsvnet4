...
@section('content')    
    <div class="text-black">
        ...
        <div class="mt-4">
            <button class="bg-gsv-purple hover:bg-gsv-purple/80 dark:bg-gsv-purple-dark dark:hover:bg-gsv-purple-dark/80 text-white font-bold py-2 px-4 rounded inline-flex items-center">
