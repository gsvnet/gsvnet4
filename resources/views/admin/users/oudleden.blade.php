    ...
    <div class="text-black dark:text-white">
        ...
        <div class="flex flex-row pb-6 gap-x-2">
            ...
            <div>
                ...
                <select class="hover:cursor-pointer appearance-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gsv-purple/50 focus:border-gsv-purple/50 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-gsv-purple/50 dark:focus:border-gsv-purple/50 py-3 px-4 pr-8" id="grid-state">
